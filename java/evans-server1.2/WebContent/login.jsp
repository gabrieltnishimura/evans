...
<head>
	<meta charset="utf-8" />
	<title>evans login</title>
	<meta content="width=device-width, initial-scale=1.0" name="viewport" />
	<meta content="E.V.A.N.S. Login System - By Metronic" name="description" />
	<meta content="" name="author" />
	<!-- BEGIN GLOBAL MANDATORY STYLES -->
	<link href="<c:url value="/plugins/bootstrap/css/bootstrap.min.css"/>" rel="stylesheet" type="text/css"/>
	<link href="<c:url value="/plugins/bootstrap/css/bootstrap-responsive.min.css"/>" rel="stylesheet" type="text/css"/>
	<link href="<c:url value="/plugins/font-awesome/css/font-awesome.min.css"/>" rel="stylesheet" type="text/css"/>
	<link href="<c:url value="/css/template/style-metro.css"/>" rel="stylesheet" type="text/css"/>
	<link href="<c:url value="/css/template/style.css"/>" rel="stylesheet" type="text/css"/>
	<link href="<c:url value="/css/template/style-responsive.css"/>" rel="stylesheet" type="text/css"/>
	<link href="<c:url value="/css/template/themes/default.css"/>" rel="stylesheet" type="text/css"/>
	<link href="<c:url value="/plugins/uniform/css/uniform.default.css"/>" rel="stylesheet" type="text/css"/>
	<link href="<c:url value="/plugins/select2/select2_metro.css"/>" rel="stylesheet" type="text/css"/>
	<!-- END GLOBAL MANDATORY STYLES -->
	<!-- BEGIN PAGE LEVEL STYLES -->
	<link href="<c:url value="/css/template/pages/login-soft.css"/>" rel="stylesheet" type="text/css"/>
...
<body class="login">
	<!-- BEGIN LOGO -->
	<div class="logo">
		<img src="<c:url value="css/img/logo-big.png"/>" alt="" />
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
		...
		<form class="form-vertical login-form" action="Login" method="post">
			<h3 class="form-title">Login to E.V.A.N.S.</h3>
...
<!-- 			<div class="forget-password">
	...
	<!-- BEGIN CORE PLUGINS -->   <script src="<c:url value="/plugins/jquery-1.10.1.min.js"/>" type="text/javascript"></script>
	<script src="<c:url value="/plugins/jquery-migrate-1.2.1.min.js"/>" type="text/javascript"></script>
	<!-- IMPORTANT! Load jquery-ui-1.10.1.custom.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip -->
	<script src="<c:url value="/plugins/jquery-ui/jquery-ui-1.10.1.custom.min.js"/>" type="text/javascript"></script>      
	...
	<script src="<c:url value="/plugins/backstretch/jquery.backstretch.min.js"/>" type="text/javascript"></script>
	<script type="text/javascript" src="<c:url value="/plugins/select2/select2.min.js"/>"></script>
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN PAGE LEVEL SCRIPTS -->
	<script src="<c:url value="/js/template/app.js"/>" type="text/javascript"></script>
	<script src="<c:url value="/js/template/login-soft.js"/>" type="text/javascript"></script>      

...
<%@page import="br.com.evans.mapping.basic.Device"%>
...
<html>
    ...
    <body>
		...
		TreeMap<String, Device> tree = deviceMonitor.getStatesTreeMap();
        ...
        <% for(int i = 0; i < keySet.length; i++) { %>
        	 <tr class="device<%= i %> device_each">
        	 	<th><label><%= keySet[i] %></label></th>
        	 	<td><input type="checkbox" <% if (tree.get(keySet[i]).isStatus()) {
        	 		%> checked="checked" <% } %> />
        	 	</td>
       	 	</tr>
       	<% } %>
